...
<select name="${AttributeConst.EMP_ADMIN_FLG.getValue()}">
    ...
    <option value="${AttributeConst.ROLE_SUPERIOR.getIntegerValue()}"<c:if test="${employee.adminFlag == AttributeConst.ROLE_SUPERIOR.getIntegerValue()}"> selected</c:if>>部長</option>
</select>
<br /><br />
